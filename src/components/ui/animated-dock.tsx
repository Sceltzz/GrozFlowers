...
// Adapted from the HextaUI AnimatedDock example for this project's stack:
// Vite + React Router-less anchor navigation (no Next.js here, so
// `next/link` becomes a plain `<a>`), and `cn` comes from the shared
// `@/lib/utils` helper instead of a private clsx/tailwind-merge pair
// re-declared in every component that needs it.
